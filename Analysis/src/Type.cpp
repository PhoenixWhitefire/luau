...
BuiltinTypes::BuiltinTypes()
    ...
    , signedIntegerType(arena->addType(Type{PrimitiveType{PrimitiveType::SignedInteger}, /*persistent*/ true}))
    , unsignedIntegerType(arena->addType(Type{PrimitiveType{PrimitiveType::UnsignedInteger}, /*persistent*/ true}))
